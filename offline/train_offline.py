...
flags.DEFINE_float('max_clip', 7., 'Loss clip value (not used in MXQL)')
...
flags.DEFINE_boolean('taylor_expansion', True, 'Use Maclaurin expansion')
flags.DEFINE_integer('taylor_dim', 8, 'Order of expansion used in Maclaurin expanded Gumbel loss')
...
def main(_):
    ...
    args = ConfigArgs(sample_random_times=FLAGS.sample_random_times,
                      ...
                      taylor_expansion=FLAGS.taylor_expansion,
                      taylor_dim=FLAGS.taylor_dim,
                      )
