...
def train(config, path, device="auto"):
    ...
    if config['parse']['env']:
        config['env'] = config['parse']['env']
    if config['parse']['loss']:
        config['alg_kwargs']['loss'] = config['parse']['loss']
    if config['parse']['beta']:
        config['alg_kwargs']['beta'] = config['parse']['beta']
    config['alg_kwargs']['taylor_dim'] = config['parse']['taylor_dim']
